...
DT::datatable(foo[, c("site", "depth_ft", "deployment", "ID", "maintenance", "desc")], class = 'cell-border stripe', options = list(
  columnDefs = list(list(className = 'dt-center', targets = c(0,1,2,3,4,5,6))),
                    pageLength = 25,
