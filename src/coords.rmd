...
m <- addLayersControl(m, baseGroups = c("nav chart", "satellite", "alt"), overlayGroups = c("LWF recs", "bay reefs", "proposed_walleye", "grid_10km", "sag bay"), position = "bottomright", options = layersControlOptions(collapsed = FALSE))
m
...
DT::datatable(out.1, class = 'cell-border stripe', options = list(dom = "ft", pageLength = nrow(out.1)))
